...
def assign_url(params,
    ...
    inside = 'dsid1=43388&dsgid1=9109&chr1=%(qseqid)s&x1=%(seq1)s&dr1up=10000&dr1down=10000&dsid2=43388&dsgid2=9109&chr2=%(sseqid)s&x2=%(seq2)s&dr2up=10000;dr2down=10000&\
dsid3=34580;chr3=%(fseqid)s;x3=%(seq3)s;dr3up=10000;dr3down=10000;num_seqs=3;hsp_overlap_limit=0;hsp_size_limit=0' %params
    url = base + inside
    return url
