...
def parse_cns_pair(cns_pairs):
    handle = open("/Users/gturco/rice_v6_cns_res/04_08_10/rice_v6_rice_v6_cns.txt", "w")
...
handle = open('/Users/gturco/rice_v6_cns_res/04_08_10/rice_v6_rice_v6.cns2.txt','r')
l = handle.readlines()        
x = l[:10]
print x
m= parse_cns_pair(l)
